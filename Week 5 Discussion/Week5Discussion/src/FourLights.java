 ...
 // ----------------------------- Methods for drawing -------------------------------
    ...
    private void lights(GL2 gl) {
        ...
        if (redLight.isSelected()) {
            float red[] = { (float) ((Math.sin(frameNumber / 25))+1)/4, 0, 0, 1 };
        ...
        gl.glPushMatrix();
        gl.glRotated(-frameNumber, frameNumber * 0.5f, 1, 0);
        ...
        if (greenLight.isSelected()) {
            float green[] = {0, (float) ((Math.sin(frameNumber / 25))+1)/4, 0, 1 };
        ...
        if (blueLight.isSelected()) {
            float blue[] = { 0, 0, (float) ((Math.sin(frameNumber / 25))+1)/4, 1 };
    ...
    public void drawObject(GL2 gl2){
      gl2.glRotated(45 * ((float) Math.sin(frameNumber/ 25)+1), 1, 1, 1);
      gl2.glScaled(5, 5, 5);
      Cuboid.draw(gl2, 5, frameNumber);
    }

 
    /**
     * Initialization, including setting up a Cam and configuring the four lights.
     */
