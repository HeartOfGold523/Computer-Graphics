...
public class Scene3D extends JPanel implements GLEventListener
{
	...
	public void display(GLAutoDrawable drawable)
	{
		...
		//rotated 30 degrees about vector (1.5, -2, 3)
		gl2.glRotated(30, 1.5, -2, 3);
		//scaled by 2.0x in all directions to display proportionally in window
		gl2.glScaled(2.0, 2.0, 2.0);
		//rotating infinitely about x-axis and y-axis throughout animation
		...
		//has a moderately slow rotational path about x-axis and y-axis throughout animation
		gl2.glTranslated(2 * Math.cos(.025 * frameNumber), 2*Math.sin(.025 * frameNumber), 0.0);
		//translated to coordinate (8, 8, 0)
		gl2.glTranslated(8.0, 8.0, 0);
		//rotated 45 degrees about vector (1.5, -2, 3)
		gl2.glRotated(45, 1.5, -2, 3);
		//scaled by 2.0x in all directions to display proportionally in window
		gl2.glScaled(2.0, 2.0, 2.0);
		//rotating infinitely about y-axis and z-axis throughout animation
		...
		//path across entire x-portion of screen throughout animation
		gl2.glTranslated(-17 + 34 * (frameNumber % 500) / 500.0, 0, 0);
		//rotated 45 degrees about vector (1.5, -2, 3)
		gl2.glRotated(45, 1.5, -2, 3);
		//scaled by 0.5x in all directions to display proportionally in window
		gl2.glScaled(0.5, 0.5, 0.5);
		//rotating about y-axis throughout animation
		gl2.glRotated(-frameNumber * 1.3, 0, 1, 0);
		...
		//translated to coordinate (-8, -8, 0)
		gl2.glTranslated(-8.0, -8.0, 0);
		//rotated 20 degrees about vector (1.5, -2, 3)
		gl2.glRotated(20, 1.5, -2, 3);
		//increasing in size in all directions until cap then starting over throughout animation cycle
		...
		gl2.glRotated(-frameNumber * 1.3, 1, 0, 0);
		...
		//scaled by 2.0x in all directions to display proportionally in window
		gl2.glScaled(2.0, 2.0, 2.0);
		//rotating about x-axis and z-axis throughout animation
		gl2.glRotated(-frameNumber * 1.3, 1, 0, 1);
